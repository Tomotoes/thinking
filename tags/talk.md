...
3.  刚刚A了一道题, 挺有意思的
    ...
    ![image-20201122200528263](<../.gitbook/assets/image (1).png>)
4.  A:Kotlin 她真的太美了。
...
11. 发现了个有趣的项目 [https://github.com/itorr/e/blob/master/index.html](https://github.com/itorr/e/blob/master/index.html)
    ...
    ![image-20201212212105825](<../.gitbook/assets/image-20201212212105825 (1).png>)
...
13. A: 我到字节 最好奇的就是 有很多很多同事 的开发环境 就是使用 mac + 触控板.. 我坚持了一周, 各种效率软件 魔改快捷方式软件 都试过了.. 撑不下去了..
    ...
    C: 那估计刚出 恰饭的比较多
14. ![image-20201224234712461](<../.gitbook/assets/image-20201224234712461 (2) (1).png>)
...
23. ![img](<../.gitbook/assets/image (20).png>)
